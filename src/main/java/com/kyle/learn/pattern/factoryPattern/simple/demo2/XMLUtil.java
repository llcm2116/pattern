...
public class XMLUtil {
    private static final String XML_FILE_NAME = "E:/ProjectPackage/myself/java/pattern/src/main/java/com/hubq/learn/pattern/factoryPattern/simple/demo2/file.xml";
